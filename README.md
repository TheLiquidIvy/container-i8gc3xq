...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i8gc3xq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i8gc3xq.containers.anotherwebservice.com/
...
```
git clone git@github.com:TheLiquidIvy/container-i8gc3xq.git
cd container-i8gc3xq
```
...
```
docker attach container-i8gc3xq
```
